...
public class Tutorial extends Levels
{
    ...
    {    
        ...
        initiateScroll(backgroundImage, -40, Globals.worldHeight - (Globals.startingHeight * Options.heightSize - Options.heightSize / 4)); //make the camera and update it to x, y
